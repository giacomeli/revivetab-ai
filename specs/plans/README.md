# Plans — Specs e Planos de Implementação

Histórico de specs e planos do projeto. Cada entrada corresponde a uma pasta
`YYYY-MM-DD-HHmmss_nome-contextual/` contendo `spec.md`, `plano.md` (ou `fase-N-*.md`) e
(opcionalmente) `decisoes.md`.
